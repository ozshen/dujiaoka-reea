                                ...
                                <div class="tk mb-3">
                                    ...
                                    <div class="form__group field">
                                        ...
                                        <div class="input-group">
                                            <img style="margin-left: 10px;" src="{{ captcha_src('buy') . time() }}" height="33px" alt="{{ __('dujiaoka.img_verify_code') }}" onclick="refresh()" id="imageCode">
                                            <script>
                                                function refresh() {
                                    ...
                                    <div class="btn-group zffs mt-3" role="group" aria-label="Basic checkbox toggle button group">
                                        ...
                                        <div class="pay-grid">
                                            ...
                                            <div class="btn pay-type text-bg-dark @if($key == 0) active @endif" data-type="{{ $way['pay_check'] }}" data-id="{{ $way['id'] }}" data-name="{{ $way['pay_name'] }}">
                                            </div>
                                            @endforeach
                                        </div>
